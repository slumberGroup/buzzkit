/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9097db53c28628de620676d0b48104ce)
// Runtime types generated with workerd@1.20260831.1 2025-06-01 nodejs_compat
interface __BaseEnv_Env {
	AUTH_CACHE: KVNamespace;
	PROVIDER_CACHE: KVNamespace;
	ENGINE_DEFS: KVNamespace;
	...
	EMAIL_FROM: "mail@buzz-mail.slumber.group";
	EMAIL_FROM_NAME: "Slumber";
	BETTER_AUTH_URL: string;
	BETTER_AUTH_SECRET: string;
	CREDENTIAL_MASTER_KEY_V1: string;
	...
	SUBSCRIBER_ACTOR: DurableObjectNamespace<import("./src/index").SubscriberActor>;
	ENGINE: Workflow<Parameters<import("./src/index").EngineWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SubscriberActor";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKFLOW_TIME_SCALE" | "TRACE_SAMPLE_RATIO" | "EMAIL_FROM" | "EMAIL_FROM_NAME" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "CREDENTIAL_MASTER_KEY_V1" | "SQIDS_ALPHABET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "OTEL_EXPORTER_OTLP_ENDPOINT" | "AXIOM_API_TOKEN" | "AXIOM_LOGS_DATASET" | "AXIOM_TRACES_DATASET" | "TINYBIRD_TOKEN" | "ENVIRONMENT" | "DASHBOARD_URL" | "TINYBIRD_URL" | "SIMULATED_LATENCY_MS">> {}
}
